class Calculator{
    constructor(previousOperationTextElement,currentOperationTextElement){
        ...
        this.clear();//because we want to set everything to default value when we open our calculator 
    }
    ...
    //add a digit to the end of the number 
    appendNumber(number){
        if(number ==='.' && this.currentOperand.includes('.')) return 
          this.currentOperand=this.currentOperand.toString()+number.toString();
        
    }
    //when user chooses to perform an operation
    ...
    //update the result on our final screen 
    updateDisplay(){
...
//now we'll select all our opertion buttons together 
const operationButtons =document.querySelectorAll('[data-operation]');
//now get rest of the buttons
